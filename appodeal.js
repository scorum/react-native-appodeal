...
const BANNER = 4;
const NATIVE = 8;
const REWARDED_VIDEO = 16;
const NON_SKIPPABLE_VIDEO = 64;
...
module.exports = {
  ...
  initialize: (appKey, adTypes, hasConsent) =>
    RNAppodeal.initialize(appKey, adTypes, hasConsent),
